...
class HttpClient:
    ...
    def _resolve_retry_policy(self, override: RetryPolicy | bool | None) -> RetryPolicy | None:
        ...
        return RetryPolicy(
            ...
            retry_methods=override.retry_methods or self.retry.retry_methods,
            retry_on_statuses=override.retry_on_statuses or self.retry.retry_on_statuses,
            ...
            should_retry=override.should_retry or self.retry.should_retry,
        )
